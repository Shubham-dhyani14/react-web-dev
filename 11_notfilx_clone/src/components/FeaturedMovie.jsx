  ...
  return (
    ...
    <div className='w-full relative overflow-hidden '>
      ...
      <div className='flex  items-center absolute top-0 left-0 w-full h-full bg-gradient-to-r from-gray-950/80 to-transparent'>
        <div className="flex w-4/12 ml-8 gap-4 flex-col text-white">
          <img className='w-9/12' src={imgBaseUrl + getImages.logos[0].file_path} alt="" />
          <div className="info text-lg">{popularMovies.results[0].overview.slice(0,140)+'...'}</div>
          <div className="flex gap-3 btn-cont text-2xl ">
            <button className='bg-gray-100/90 hover:bg-slate-100 text-black  font-bold px-5 py-2 rounded-md flex items-center gap-2'>
